    ...
    async onNodeInit({ zclNode }) {
        ...
        try {
            ...
            this.registerCapability('dim', CLUSTER.LEVEL_CONTROL, {
                ...
                report: 'currentLevel',
                setParser: (value) => (value * maxMoveLevel),
            ...
            //     }
            //   ]);
            zclNode.endpoints[1].clusters[CLUSTER.LEVEL_CONTROL.NAME].on('attr.currentLevel', (value) => { this.log("Hi I'm running :" + value); });
            zclNode.endpoints[1].clusters[CLUSTER.ON_OFF.NAME].on('attr.onOff', (value) => { this.log("Hi I'm running :" + value); });
